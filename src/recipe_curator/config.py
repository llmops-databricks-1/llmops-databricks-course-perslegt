...
class ProjectConfig(BaseModel):
	...
	def from_yaml(cls, config_path: str | Path, env: str = "dev") -> "ProjectConfig":
		...
		return cls(**config_data[env_name])
...
def load_config(config_path: str | Path = "project_config.yml", env: str | None = None) -> ProjectConfig:
...
def get_env(spark: Any | None = None) -> str:
